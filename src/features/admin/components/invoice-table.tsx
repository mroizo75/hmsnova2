                ...
                >
                  ...
                  <TableCell>
                    <div>
                      ...
                      {invoice.tenant.aiIncludedInAgreement ? (
                        <Badge className="ml-2 align-middle">AI inkl.</Badge>
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        <DropdownMenuItem
                          ...
                          disabled={!!invoice.fikenInvoiceId || deletingId === invoice.id}
                          onClick={() => handleDelete(invoice.id)}
                        >
                          <Trash2 className="mr-2 h-4 w-4" />
                          {invoice.fikenInvoiceId ? "Synkronisert (kan ikke slettes)" : "Slett faktura"}
                        </DropdownMenuItem>
                      </DropdownMenuContent>
                    </DropdownMenu>
                  </TableCell>
