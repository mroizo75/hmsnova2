...
export const WIDGET_REGISTRY: WidgetDefinition[] = [
  ...
  },
  {
    id: "absence",
    label: "Fravær & ferie",
    description: "Registrering og oppfølging av fravær, ferie og permisjon (AML § 5-1)",
    icon: CalendarDays,
  ...
  },
  {
    id: "boarding",
    label: "Onboarding",
    description: "Onboarding og offboarding med lovpålagte sjekklister (AML § 14-5, § 3-5)",
    icon: UserPlus,
  ...
  },
  {
    ...
    label: "Personalarkiv",
    description: "Personalmapper i Cloudflare R2 (GDPR art. 5, 6 og 15)",
    icon: FolderArchive,
  ...
  },
  {
    id: "skjenking",
    label: "Skjenking",
    description: "Internkontroll etter alkoholloven: alderskontroll, beruselse og bortvisning",
    icon: Wine,
    href: "/dashboard/skjenking",
    category: "sikkerhet",
    color: "text-purple-700",
    bgColor: "bg-purple-50",
    borderColor: "border-purple-200",
    permission: "skjenking",
  },
  {
