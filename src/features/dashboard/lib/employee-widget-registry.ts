...
export const EMPLOYEE_WIDGET_REGISTRY: EmployeeWidgetDefinition[] = [
  ...
  },
  {
    id: "emp-absence",
    label: "Fravær & ferie",
    description: "Registrer fravær og se dine fraværsoversikter",
    icon: CalendarDays,
    href: "/ansatt/fravaer",
    color: "text-teal-600",
    bgColor: "bg-teal-100",
    borderColor: "border-teal-300",
    adminWidgetId: "absence",
  },
  {
    id: "emp-boarding",
    label: "Onboarding",
    description: "Se dine onboarding-oppgaver",
    icon: UserPlus,
    href: "/ansatt/onboarding",
    color: "text-indigo-600",
    bgColor: "bg-indigo-100",
    borderColor: "border-indigo-300",
    adminWidgetId: "boarding",
  },
  {
    id: "emp-personnel",
    label: "Min personalmappe",
    description: "Se dokumenter i din personalmappe (GDPR art. 15)",
    icon: FolderArchive,
    href: "/ansatt/personalmappe",
    color: "text-slate-600",
    bgColor: "bg-slate-100",
    borderColor: "border-slate-300",
    adminWidgetId: "personnel-archive",
  },
  {
