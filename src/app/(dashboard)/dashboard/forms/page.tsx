                ...
                {forms.map((form) => (
                  <TableRow key={form.id} className="hover:bg-muted/50">
                    ...
                    <TableCell>
                      <div className="flex items-center justify-end gap-2">
                        <Link
                          href={buildFormDetailHref(form.id, selectedProjectId, showAllTemplates)}
                        >
                        ...
                        <Link
                          href={buildFormFillHref(form.id, selectedProjectId, showAllTemplates)}
                        >
              ...
              <div className="mt-6">
                <Pagination>
                  <PaginationContent>
                    ...
                    {currentPage > 2 && (
                      <PaginationItem>
                        <PaginationLink href={createFormsPageHref(1, selectedProjectId, query, showAllTemplates)}>
                          1
                        </PaginationLink>
                      </PaginationItem>
                    )}
