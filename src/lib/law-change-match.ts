...
const HMS_KEYWORDS: Array<{ keyword: string; industries: string[] }> = [
  ...
  { keyword: "kjemikalie", industries: ["manufacturing", "construction", "healthcare", "automotive"] },
  { keyword: "stoffkartotek", industries: ["manufacturing", "construction", "automotive"] },
  { keyword: "eksponering", industries: ["manufacturing", "construction", "healthcare", "automotive"] },
  { keyword: "tiltaksverdi", industries: ["manufacturing", "construction", "automotive"] },
  { keyword: "grenseverdi", industries: ["manufacturing", "construction", "automotive"] },
  ...
  { keyword: "verkstedforskrift", industries: ["automotive"] },
  { keyword: "dieseleksos", industries: ["automotive"] },
  { keyword: "diisocyanat", industries: ["automotive", "manufacturing"] },
