...
export const SUPPORTED_INDUSTRIES: ReadonlyArray<SupportedIndustryOption> = [
  ...
  { value: "office", label: "Kontor og administrasjon", templates: 8 },
  { value: "consulting", label: "Rådgivning og konsulent", templates: 8 },
  { value: "legal", label: "Advokat og juridisk", templates: 10 },
  { value: "accounting", label: "Regnskap og revisjon", templates: 10 },
  { value: "finance", label: "Finans og forsikring", templates: 10 },
  { value: "av_installation", label: "AV, montasje og installasjon", templates: 14 },
  { value: "telecom", label: "Telekommunikasjon", templates: 10 },
  { value: "cleaning", label: "Renhold og eiendomsdrift", templates: 12 },
  { value: "security", label: "Vakt og sikkerhet", templates: 10 },
  { value: "staffing", label: "Bemanning og vikar", templates: 10 },
  { value: "architecture", label: "Arkitektur og design", templates: 8 },
  { value: "media", label: "Media, reklame og kommunikasjon", templates: 8 },
...
const INDUSTRY_ALIASES: Readonly<Record<string, string>> = {
  ...
  mining: "bergverk",
  kontor: "office",
  "kontor og administrasjon": "office",
  office: "office",
  administration: "office",
  rådgivning: "consulting",
  konsulent: "consulting",
  "rådgivning og konsulent": "consulting",
  consulting: "consulting",
  advokat: "legal",
  "advokat og juridisk": "legal",
  juridisk: "legal",
  legal: "legal",
  regnskap: "accounting",
  revisjon: "accounting",
  "regnskap og revisjon": "accounting",
  ...
  bank: "finance",
  av: "av_installation",
  montasje: "av_installation",
  installasjon: "av_installation",
  "av-montasje": "av_installation",
  "av_installation": "av_installation",
  "av, montasje og installasjon": "av_installation",
  telekom: "telecom",
  telekommunikasjon: "telecom",
  telecom: "telecom",
  renhold: "cleaning",
  "renhold og eiendomsdrift": "cleaning",
  eiendomsdrift: "cleaning",
  cleaning: "cleaning",
  vakt: "security",
  sikkerhet: "security",
  "vakt og sikkerhet": "security",
  security: "security",
  bemanning: "staffing",
  vikarbyrå: "staffing",
  "bemanning og vikar": "staffing",
  staffing: "staffing",
  arkitektur: "architecture",
  "arkitektur og design": "architecture",
  design: "architecture",
  media: "media",
  reklame: "media",
  kommunikasjon: "media",
  "media, reklame og kommunikasjon": "media",
  kultur: "culture_sport",
  idrett: "culture_sport",
  underholdning: "culture_sport",
  sport: "culture_sport",
...
const hospitalityPackage: IndustryPackage = {
  ...
  courseTemplates: [
    ...
    { courseKey: "hospitality_cleaning", title: "Renhold og hygiene i servering", description: "Dokumentert renhold av lokaler og utstyr. IK-mat § 5 nr. 3 og 6 og 852/2004 vedlegg II.", isRequired: true, validityYears: 2 },
  ...
  legalReferences: [
    ...
    { title: "Internkontroll skjenking", paragraphRef: "Alkoholforskriften § 8-1 og § 8-3", description: "Bevillingshaver skal ha dokumentert internkontroll med rutiner for alderskontroll, beruselse, bortvisning, opplæring og jevnlig gjennomgang.", sourceUrl: "https://lovdata.no/dokument/SF/forskrift/2005-06-08-538/KAPITTEL_8" },
