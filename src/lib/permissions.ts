...
export interface RolePermissions {
  ...
  // Varsling (Whistleblowing) — AML kap. 2 A, GDPR art. 5 og 9
  canSubmitWhistleblowing: boolean;
  canViewWhistleblowing: boolean; // Innboks: at sak finnes (status/dato)
  canViewWhistleblowingContent: boolean; // Fulltekst, identitet, vedlegg
  canHandleWhistleblowing: boolean; // Behandle saken
...
export const rolePermissions: Record<Role, RolePermissions> = {
  ...
  VARSLINGSANSVARLIG: {
    ...
    canSubmitWhistleblowing: true,
    canViewWhistleblowing: true,
    canViewWhistleblowingContent: true,
...
export function getRoleDescription(role: Role): string {
  const descriptions: Record<Role, string> = {
    ...
    VARSLINGSANSVARLIG:
      "Mottar og behandler varslingssaker. Eneste rolle som kan se innholdet i et varsel (AML kap. 2 A, GDPR art. 5).",
  };
