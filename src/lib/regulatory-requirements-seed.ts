...
export const REGULATORY_REQUIREMENTS: RegulatoryRequirementSeed[] = [
  ...
  // === Bygg og anlegg ===
  {
    ...
    hmsNovaRoute: "/dashboard/construction-compliance",
    severity: "MANDATORY",
  },
  // === Maskiner ===
  {
  ...
  },
  {
    ...
    hmsNovaRoute: "/dashboard/ik-mat/allergener",
    severity: "MANDATORY",
  },
  {
    title: "Temperaturkontroll kjøl og frys",
    description:
      "Næringsmiddelvirksomheter skal holde kjølte og frosne varer ved forsvarlig temperatur og dokumentere kontrollene. Typiske grenser: kjøl 0–4 °C, frys −18 °C.",
    legalBasis: "IK-mat § 5 nr. 3 og 6, forordning (EF) 852/2004 vedlegg II",
    sourceUrl: "https://lovdata.no/dokument/SF/forskrift/1994-12-15-1187/§5",
    triggerActivities: ["food_handling"],
    hmsNovaFeature: "temperatur",
    hmsNovaRoute: "/dashboard/ik-mat/temperatur",
    severity: "MANDATORY",
  },
  {
    title: "Varemottak og sporbarhet",
    description:
      "Virksomheten skal kunne spore næringsmidler ett ledd bakover (leverandør/parti) og ett ledd fremover, og kontrollere varer ved mottak inkludert temperatur og holdbarhet.",
    legalBasis: "Forordning (EF) 178/2002 art. 18, IK-mat § 5 nr. 3 og 6",
    sourceUrl: "https://lovdata.no/dokument/SF/forskrift/2008-12-22-1620",
    triggerActivities: ["food_handling"],
    hmsNovaFeature: "varemottak",
    hmsNovaRoute: "/dashboard/ik-mat/varemottak",
    severity: "MANDATORY",
  },
  {
    title: "Renholdslogg for kjøkken og servering",
    description:
      "Lokaler og utstyr som brukes til næringsmidler skal rengjøres systematisk. Registreringene skal vise hva som er gjort, når og av hvem.",
    legalBasis: "IK-mat § 5 nr. 3 og 6, forordning (EF) 852/2004 vedlegg II",
    sourceUrl: "https://lovdata.no/dokument/SF/forskrift/1994-12-15-1187/§5",
    triggerActivities: ["food_handling"],
    hmsNovaFeature: "renhold",
    hmsNovaRoute: "/dashboard/ik-mat/renhold",
    severity: "MANDATORY",
  },
  {
    title: "Internkontroll skjenking",
    description:
      "Innehaver av skjenkebevilling skal ha dokumentert internkontroll med oversikt over krav, ansvar, rutiner, avvikshåndtering og jevnlig gjennomgang.",
    legalBasis: "Alkoholforskriften § 8-1 og § 8-3, alkoholloven § 1-7c",
    sourceUrl: "https://lovdata.no/dokument/SF/forskrift/2005-06-08-538/KAPITTEL_8",
    triggerActivities: ["alcohol_serving"],
    hmsNovaFeature: "skjenking",
    hmsNovaRoute: "/dashboard/skjenking",
    routineCategory: "HOTELL_RESTAURANT",
    severity: "MANDATORY",
  },
  // === Brann ===
  {
    ...
    hmsNovaRoute: "/dashboard/fire-drills",
