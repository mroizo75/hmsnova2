...
async function seedGlobalInspectionTemplates(createdById: string) {
  const templates: Array<{
    ...
    {
      name: "Kjøkken- og mathygiene",
      description: "Inspeksjon av kjøkken, temperaturkontroll, renhold og allergenhåndtering for serveringsbedrifter.",
      category: "KJOKKEN_HYGIENE",
      riskCategory: "HEALTH" as const,
      industryScope: ["hospitality"],
      checklist: {
        items: [
          { type: "heading", title: "Temperatur og oppbevaring" },
          { type: "item", title: "Kjølerom holder 0–4 °C", checked: false },
          { type: "item", title: "Frysere holder ≤ −18 °C", checked: false },
          { type: "item", title: "Varmholding ≥ 60 °C kontrollert", checked: false },
          { type: "item", title: "Råvarer og ferdigmat er adskilt", checked: false },
          { type: "heading", title: "Renhold og hygiene" },
          { type: "item", title: "Arbeidsflater og utstyr rengjøres mellom oppgaver", checked: false },
          { type: "item", title: "Oppvaskmaskinen når ≥ 80 °C skylletemperatur", checked: false },
          { type: "item", title: "Ansatte følger håndhygiene-rutiner", checked: false },
          { type: "item", title: "Renholdsplan følges og dokumenteres", checked: false },
          { type: "heading", title: "Allergener og merking" },
          { type: "item", title: "Allergenliste er oppdatert og tilgjengelig", checked: false },
          { type: "item", title: "Ansatte kan informere om allergener i rettene", checked: false },
          { type: "item", title: "Tørrvarelager er ryddig og merket med holdbarhet", checked: false },
        ],
      },
    },
    {
      name: "Smittevern og medisinrunde",
      description: "Inspeksjon av smitteverntiltak, medisinoppbevaring og pasient-/brukersikkerhet.",
      category: "SMITTEVERN",
      riskCategory: "HEALTH" as const,
      industryScope: ["healthcare"],
      checklist: {
        items: [
          { type: "heading", title: "Smittevern" },
          { type: "item", title: "Hånddesinfeksjon ved alle innganger", checked: false },
          { type: "item", title: "Smittevernutstyr (hansker, munnbind, frakk) er tilgjengelig", checked: false },
          { type: "item", title: "Isolatrom er klargjort og merket", checked: false },
          { type: "item", title: "Smitteavfall håndteres korrekt", checked: false },
          { type: "heading", title: "Medisin og utstyr" },
          { type: "item", title: "Medisinskapet er låst og temperaturovervåket", checked: false },
          { type: "item", title: "A/B-preparater er forsvarlig oppbevart", checked: false },
          { type: "item", title: "Nødmedikamenter er innenfor holdbarhet", checked: false },
          { type: "item", title: "Medisinsk utstyr er kontrollert og kalibrert", checked: false },
          { type: "heading", title: "Pasientsikkerhet" },
          { type: "item", title: "Fallforebygging (sklimatter, håndtak) er ivaretatt", checked: false },
          { type: "item", title: "Pasientvarslingsanlegg fungerer", checked: false },
          { type: "item", title: "Hjelpemidler for forflytning er tilgjengelige", checked: false },
        ],
      },
    },
    {
      name: "Kjøretøy- og flåtekontroll",
      description: "Daglig/ukentlig kontroll av kjøretøy, lastsikring og sjåførutstyr.",
      category: "KJORETOY",
      riskCategory: "SAFETY" as const,
      industryScope: ["transport"],
      checklist: {
        items: [
          { type: "heading", title: "Kjøretøystatus" },
          { type: "item", title: "Dekk – mønsterdybde og trykk OK", checked: false },
          { type: "item", title: "Bremser fungerer tilfredsstillende", checked: false },
          { type: "item", title: "Lys, refleks og blinkers fungerer", checked: false },
          { type: "item", title: "Ruter og speil er hele og rene", checked: false },
          { type: "heading", title: "Lastsikring" },
          { type: "item", title: "Stropper og kjettinger er i god stand", checked: false },
          { type: "item", title: "Lasten er sikret mot forskyvning", checked: false },
          { type: "item", title: "Vektgrenser er overholdt", checked: false },
          { type: "heading", title: "Sjåførutstyr og beredskap" },
          { type: "item", title: "Førstehjelpsutstyr er komplett", checked: false },
          { type: "item", title: "Brannslokker i førerhus kontrollert", checked: false },
          { type: "item", title: "Refleksvest og varseltrekant tilgjengelig", checked: false },
          { type: "item", title: "Kjøre- og hviletidslogg er oppdatert", checked: false },
        ],
      },
    },
    {
      name: "Stillasinspeksjon",
      description: "Kontroll av stillasoppstilling, forankring og sikring iht. stillasforskriften.",
      category: "STILLAS",
      riskCategory: "SAFETY" as const,
      industryScope: ["construction", "av_installation"],
      checklist: {
        items: [
          { type: "heading", title: "Grunnforhold og oppstilling" },
          { type: "item", title: "Underlaget er stabilt og plant", checked: false },
          { type: "item", title: "Fotplater/bunnrammer er riktig plassert", checked: false },
          { type: "item", title: "Forankring til vegg/konstruksjon er utført", checked: false },
          { type: "heading", title: "Plattformer og adkomst" },
          { type: "item", title: "Alle plattformer har rekkverk (topp, midt og fotlist)", checked: false },
          { type: "item", title: "Adkomststiger er sikret og i god stand", checked: false },
          { type: "item", title: "Åpninger i plattform er sikret", checked: false },
          { type: "heading", title: "Dokumentasjon og bruk" },
          { type: "item", title: "Stillaset er kontrollert av kompetent person og merket", checked: false },
          { type: "item", title: "Brukstillatelse (grønt skilt) er synlig", checked: false },
          { type: "item", title: "Lastgrense er oppgitt og overholdes", checked: false },
          { type: "item", title: "Ingen uautoriserte endringer er gjort", checked: false },
        ],
      },
    },
    {
      name: "Butikk- og kundeområde",
      description: "Sikkerhetsinspeksjon av kundeområde, kasse, lager og varelevering i butikkdrift.",
      category: "BUTIKK",
      riskCategory: "OPERATIONAL" as const,
      industryScope: ["retail"],
      checklist: {
        items: [
          { type: "heading", title: "Kundeområde" },
          { type: "item", title: "Gulv er sklisikre og uten snublefare", checked: false },
          { type: "item", title: "Hyller og stativer er stabile", checked: false },
          { type: "item", title: "Nødutganger og rømningsveier er frie", checked: false },
          { type: "item", title: "Belysning er tilstrekkelig", checked: false },
          { type: "heading", title: "Kasse og ansattområde" },
          { type: "item", title: "Ergonomi ved kassepunkt er vurdert", checked: false },
          { type: "item", title: "Ran-/trusselforebyggende tiltak er iverksatt", checked: false },
          { type: "item", title: "Pauserom og garderobe er tilfredsstillende", checked: false },
          { type: "heading", title: "Lager og varelevering" },
          { type: "item", title: "Pallereoler er innenfor lastgrenser", checked: false },
          { type: "item", title: "Varemottak skjer sikkert (rampe, truck, palljakk)", checked: false },
          { type: "item", title: "Brannslokkeutstyr er tilgjengelig og kontrollert", checked: false },
        ],
      },
    },
    {
      name: "Skole- og barnehagemiljø",
      description: "Vernerunde for undervisnings- og lekearealer, uteområde og brannsikkerhet.",
      category: "SKOLE",
      riskCategory: "HEALTH" as const,
      industryScope: ["education"],
      checklist: {
        items: [
          { type: "heading", title: "Undervisnings- og lekearealer" },
          { type: "item", title: "Møbler og utstyr er i forsvarlig stand", checked: false },
          { type: "item", title: "Leker er uten skaderisiko", checked: false },
          { type: "item", title: "Inneklima (ventilasjon, temperatur) er tilfredsstillende", checked: false },
          { type: "heading", title: "Uteområde" },
          { type: "item", title: "Gjerder og porter er hele og fungerer", checked: false },
          { type: "item", title: "Lekeutstyr er kontrollert (årskontroll utført)", checked: false },
          { type: "item", title: "Underlag under lekeutstyr er støtdempende", checked: false },
          { type: "item", title: "Sandkasse er ren og drenert", checked: false },
          { type: "heading", title: "Brannsikkerhet og beredskap" },
          { type: "item", title: "Brannøvelse gjennomført iht. plan", checked: false },
          { type: "item", title: "Rømningsveier er frie og merket", checked: false },
          { type: "item", title: "Førstehjelpsutstyr og hjertestarter er tilgjengelig", checked: false },
          { type: "item", title: "Beredskapsplan er kjent for ansatte", checked: false },
        ],
      },
    },
    {
      name: "Gårdsrunde – landbruk",
      description: "Vernerunde for gårdsbruk: maskiner, dyr, kjemikalier og driftsbygninger.",
      category: "GARD",
      riskCategory: "SAFETY" as const,
      industryScope: ["agriculture"],
      checklist: {
        items: [
          { type: "heading", title: "Maskiner og redskap" },
          { type: "item", title: "Traktorer har fungerende vern og nødstopper", checked: false },
          { type: "item", title: "PTO-aksler er avskjermet", checked: false },
          { type: "item", title: "Vedlikeholdslogg er oppdatert", checked: false },
          { type: "heading", title: "Dyrehåndtering" },
          { type: "item", title: "Innhegning og gjerder er i forsvarlig stand", checked: false },
          { type: "item", title: "Fanghekk og skillevegger er trygge", checked: false },
          { type: "item", title: "Veterinærmedisiner er forsvarlig oppbevart", checked: false },
          { type: "heading", title: "Kjemikalier og sprøytemidler" },
          { type: "item", title: "Plantevernmidler er låst og merket", checked: false },
          { type: "item", title: "Verneutstyr ved sprøyting er tilgjengelig og i orden", checked: false },
          { type: "item", title: "Sikkerhetsdatablader er tilgjengelige", checked: false },
          { type: "heading", title: "Bygninger" },
          { type: "item", title: "Stiger og arbeid i høyden har fallsikring", checked: false },
          { type: "item", title: "Silo og trange rom er merket med gassfare", checked: false },
          { type: "item", title: "Brannslokkeutstyr er kontrollert", checked: false },
        ],
      },
    },
    {
      name: "Offshore plattform-runde",
      description: "Inspeksjon for offshore-installasjoner: arbeidstillatelser, prosessikkerhet, fallsikring og beredskap.",
      category: "OFFSHORE",
      riskCategory: "SAFETY" as const,
      industryScope: ["offshore", "oil_gas", "marine"],
      checklist: {
        items: [
          { type: "heading", title: "Arbeidstillatelser" },
          { type: "item", title: "Alle pågående jobber har gyldig AT", checked: false },
          { type: "item", title: "SJA er gjennomført for risikoarbeid", checked: false },
          { type: "item", title: "Isolasjonsplan er verifisert", checked: false },
          { type: "heading", title: "Prosessikkerhet" },
          { type: "item", title: "Gassdetektorer er kalibrert og fungerer", checked: false },
          { type: "item", title: "Ventiler og trykkavlastning er kontrollert", checked: false },
          { type: "item", title: "Ex-soner er korrekt merket", checked: false },
          { type: "heading", title: "Fallsikring og løft" },
          { type: "item", title: "Rekkverk og gangveier er i forsvarlig stand", checked: false },
          { type: "item", title: "Personlig fallsikringsutstyr er kontrollert", checked: false },
          { type: "item", title: "Løfteutstyr har gyldig sertifikat", checked: false },
          { type: "heading", title: "Beredskap" },
          { type: "item", title: "Livbåter/redningsflåter er klargjort", checked: false },
          { type: "item", title: "Brannposter og slokkeutstyr er kontrollert", checked: false },
          { type: "item", title: "Mønstringsrutiner er kjent for alt personell", checked: false },
        ],
      },
    },
  ];
